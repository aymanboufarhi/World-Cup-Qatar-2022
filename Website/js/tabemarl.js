...
function ajt()
{
 ...
 var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td id='name_row"+table_len+"'>"+new_name+"</td><td id='flag'> <img id='flag'src='./images/95.gif'> </td> <td id='natio'>Marocain</td><td id='country_row"+table_len+"'>"+new_country+"</td><td id='age_row"+table_len+"'>"+new_age+"</td><td><input type='button' id='edit_button"+table_len+"' value='Edit' class='edit' onclick='edition("+table_len+")'> <input type='button' id='save_button"+table_len+"' value='Save' class='save' onclick='sauver("+table_len+")'> <input type='button' value='Delete' class='delete' onclick='remove("+table_len+")'></td></tr>";
